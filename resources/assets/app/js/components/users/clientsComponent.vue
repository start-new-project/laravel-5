                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <router-link :to="{name:'admin.users.add',params:{type:'client'}}" class="btn btn-sm btn-success m-1 d-flex">
...
<script>
    export default {
        ...
        created(){
            axios.get($('#api-route').attr('route')+'/users?filter=client').then(response=>{
